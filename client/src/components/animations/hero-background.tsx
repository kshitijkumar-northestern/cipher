...
const FRAGMENT = `
  ...
  void main() {
    ...
    vec3 purple = vec3(0.45, 0.2, 1.0);
    vec3 blue   = vec3(0.25, 0.4, 1.0);
    vec3 cyan   = vec3(0.1, 0.85, 0.95);
    vec3 teal   = vec3(0.05, 0.75, 0.55);
    ...
    vec3 color;
    if (px < 0.25) {
      color = mix(purple, blue, px / 0.25);
    } else if (px < 0.5) {
      color = mix(blue, cyan, (px - 0.25) / 0.25);
    } else if (px < 0.75) {
      color = mix(cyan, teal, (px - 0.5) / 0.25);
    } else {
      color = mix(teal, green, (px - 0.75) / 0.25);
    }
